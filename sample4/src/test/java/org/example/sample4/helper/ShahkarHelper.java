...
import org.example.sample4.helper.requestModel.Address;
import org.example.sample4.helper.requestModel.Service;
...
import static org.example.sample4.helper.ProviderInfo.MCI_CODE;
...
public class ShahkarHelper {
    ...
    public static ShahkarRequestBody getIranianPerson() throws SQLException {
...
//        ConnectionDataBase.insertCache(number, Integer.parseInt(birthDate), fatherName, nationalId, 0, name, family, gender);
        return ShahkarRequestBody.builder()
                .requestId(generateRequestId(MCI_CODE))
    ...
    public static String getIranianMenPerson() throws SQLException {
        String nationalId = generateRandomId();
        int type = 0;
        int id = ConnectionDataBase.insertValue(nationalId, type);
        String birthDate = ShahkarHelper.generateRandomDateOfBirth();
        ...
        int gender = 1;
        ConnectionDataBase.insertCache(number, Integer.parseInt(birthDate), fatherName, nationalId, 0, name, family, gender);
        ShahkarRequestBody iranianMenRequest = ShahkarRequestBody.builder()
                .requestId(generateRequestId(MCI_CODE))
                .service(mobile())
                .mobile(generateMobileNumber())
                .email("www.test@gmail.com")
                ...
                .address(iranianAddress)//todo
                .build();
        return new Gson().toJson(iranianMenRequest);
    }
